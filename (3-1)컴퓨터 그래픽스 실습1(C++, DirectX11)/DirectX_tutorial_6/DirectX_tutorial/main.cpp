...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR pScmdline, int iCmdshow)
{
	...
	char filename[5][256] = { "../DirectX_tutorial/Data/Obj/objCotage.obj","../DirectX_tutorial/Data/Obj/objWolf.obj", "../DirectX_tutorial/Data/Obj/crate.obj",
	"../DirectX_tutorial/Data/Obj/objLowpolyDeer.obj",  "../DirectX_tutorial/Data/Obj/Barrel.obj" };
...
bool LoadDataStructures(char* filename, int vertexCount, int textureCount, int normalCount, int faceCount, int num)
{
	...
	for (int i = 0; i < faceIndex; i++)
	{
		...
		fout << vertices[vIndex].x - (num * 10) << ' ' << vertices[vIndex].y << ' ' << vertices[vIndex].z << ' '
