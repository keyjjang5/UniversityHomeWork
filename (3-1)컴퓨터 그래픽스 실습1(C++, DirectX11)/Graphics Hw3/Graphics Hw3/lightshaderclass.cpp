...
bool LightShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, (WCHAR*)L"../Graphics Hw3/data/light.vs", (WCHAR*)L"../Graphics Hw3/data/light.ps");
	if (!result)
	{
		return false;
	}
...
// hw4 추가분
bool LightShaderClass::changeLinear(ID3D11Device* device)
{
	HRESULT result;
	D3D11_SAMPLER_DESC samplerDesc;
...
// hw4 추가분
bool LightShaderClass::changePoint(ID3D11Device* device)
{
	HRESULT result;
	D3D11_SAMPLER_DESC samplerDesc;
