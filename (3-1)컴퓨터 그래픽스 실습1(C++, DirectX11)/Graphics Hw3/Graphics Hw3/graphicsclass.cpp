...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	// 변경 seafloor -> myTexture
	result = m_Model->Initialize(m_D3D->GetDevice(), (char*)"../Graphics Hw3/data/cube.txt", (WCHAR*)L"../Graphics Hw3/data/myTexture.dds");
...
void GraphicsClass::changeLinear()
{
	m_LightShader->changeLinear(m_D3D->GetDevice());
}

void GraphicsClass::changePoint()
{
	m_LightShader->changePoint(m_D3D->GetDevice());
}