...
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_SCROLLBAR1, scrollBarTest);
...
BEGIN_MESSAGE_MAP(CMFCApplication7Dlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_NOTIFY(NM_THEMECHANGED, IDC_SCROLLBAR1, &CMFCApplication7Dlg::scrollBarcont)
	ON_EN_UPDATE(IDC_EDIT1, &CMFCApplication7Dlg::editUpdate)
	ON_WM_HSCROLL()
END_MESSAGE_MAP()
...
BOOL CMFCApplication7Dlg::OnInitDialog()
{
	...
	scrollBarTest.SetScrollRange(0, 100);
	editTest.SetWindowText(_T("0"));
...
void CMFCApplication7Dlg::scrollBarcont(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void CMFCApplication7Dlg::editUpdate()
{
...
void CMFCApplication7Dlg::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar)
{
